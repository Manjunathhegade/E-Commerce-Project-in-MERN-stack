...
class whiskyCategory extends React.Component {
constructor(props) {
    super(props);
...
componentDidMount() {
    ...
    this.WhiskyCategory = "whisky"
    axios.get(`http://localhost:5000/product/${this.WhiskyCategory}`)
        .then(result => this.setState({ whiskyProducts: result.data }))
...
onSendCart(id,name,img,price){
    ...
    render() {
        ...
        return (
            ...
            <CategoryNav />
            <hr></hr>
            <h3>Category / Whisky </h3>
            <hr></hr>
            <div className="container">
                <div className="row" style={{margin:30}}>
                    {this.state.whiskyProducts.map((row) => (
                        <div className="card">
                        <br></br>
                        <div className="p-1">
