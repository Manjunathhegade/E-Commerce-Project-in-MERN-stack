...
class RumCategory extends React.Component {
constructor(props) {
    super(props);
...
componentDidMount() {
    ...
    this.RumCategory = "Rum"
    axios.get(`http://localhost:5000/product/${this.RumCategory}`)
        .then(result => this.setState({ rumProducts: result.data }))
            ...
            <div>
                ...
                <div className="container">
                    <div className="row" style={{margin:30}}>
                        {this.state.rumProducts.map((row) => (
                            <div className="card">
                            <br></br>
                            <div className="p-1">
