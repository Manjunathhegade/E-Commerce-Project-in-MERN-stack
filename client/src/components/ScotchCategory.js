...
class ScotchCategory extends React.Component {
constructor(props) {
    super(props);
...
componentDidMount() {
    ...
    this.ScotchCategory = "Scotch"
    axios.get(`http://localhost:5000/product/${this.ScotchCategory}`)
        .then(result => this.setState({ scotchProducts: result.data }))
        .catch(error => console.log(error))
    console.log(this.state.rumProducts)
}
...
onSendCart(id,name,img,price){
    ...
    render() {
        ...
        return (
            ...
            <CategoryNav />
            <hr></hr>
            <h3>Category / Scotch </h3>
            <hr></hr>
            <div className="container">
                <div className="row" style={{margin:30}}>
                    {this.state.scotchProducts.map((row) => (
                        <div className="card">
                        <br></br>
                        <div className="p-1">
